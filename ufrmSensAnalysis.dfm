object frmSensitiveAnalysis: TfrmSensitiveAnalysis
  ...
  object rgnAS: TIWRegion
    ...
    object TIWPopupMenuButton6: TTIWPopupMenuButton
      Left = 1084
      Top = 148
      Width = 54
      Height = 27
  ...
  object rgnsav: TIWRegion
    ...
    object tbctrlVariation: TIWTabControl
      Left = 16
      Top = 192
      Width = 1190
      Height = 567
      ...
      DesignSize = (
        1190
        567)
      object tbctrlVariationPage1: TIWTabPage
        Left = 0
        Top = 20
        Width = 1190
        Height = 547
        ...
        object btnbackweight: TIWButton
          Left = 947
          Top = 376
          Width = 97
          Height = 27
          ...
          ScriptEvents = <>
          TabOrder = 32
          OnClick = btnbackweightClick
        end
        object btnsaveWeight: TIWButton
          Left = 1061
          Top = 376
          Width = 97
          Height = 27
          ...
          ScriptEvents = <>
          TabOrder = 33
          OnClick = btnsaveWeightClick
        end
        object btnstartWeight: TIWButton
          Left = 932
          Top = 425
          Width = 226
          Height = 43
        ...
        object IWLabel17: TIWLabel
          ...
          HasTabOrder = False
          FriendlyName = 'lblSOCSAV'
          Caption = 'Please, select below which criteria you want to vary:'
          RawText = False
        end
        object rgnweight: TIWRegion
          Left = 24
          Top = 48
          Width = 1129
          Height = 298
          ...
          object grdweight: TTIWAdvWebGrid
            ...
            Columns = <
              ...
              item
                ...
                SpinEditMinValue = 0
                Title = 
                  '<FONT  size="2" face="Verdana"><B><P align="center">Preference D' +
                  'irection</P></B></FONT>'
                Width = 200
                SortFormat = sfAlphabetic
              end
      ...
      object tbctrlVariationPage0: TIWTabPage
        Left = 0
        Top = 20
        Width = 1190
        Height = 547
        ...
        object btnbackmconseq: TIWButton
          Left = 947
          Top = 376
          Width = 97
          Height = 27
          ...
          ScriptEvents = <>
          TabOrder = 35
          OnClick = btnbackmconseqClick
        end
        object btnsavemconseq: TIWButton
          Left = 1061
          Top = 376
          Width = 97
          Height = 27
          ...
          Font.Size = 10
          Font.Style = [fsBold]
          FriendlyName = 'btnsavemconseq'
          ScriptEvents = <>
          TabOrder = 36
          OnClick = btnsavemconseqClick
        end
        object btnStartmconseq: TIWButton
          Left = 932
          Top = 425
          Width = 226
          Height = 43
          ...
          Font.Size = 10
          Font.Style = [fsBold]
          FriendlyName = 'btnStartmconseq'
          ScriptEvents = <>
          TabOrder = 37
          OnClick = btnStartmconseqClick
        end
        object LBLInformation: TIWLabel
          Left = 24
          Top = 354
          Width = 251
          Height = 16
          ...
          object grdvariation: TTIWAdvWebGrid
            ...
            Columns = <
              ...
              item
                ...
                SpinEditMinValue = 0
                Title = 
                  '<FONT  size="2" face="Verdana"><B><P align="center">Type</P></B>' +
                  '</FONT>'
                Width = 200
                SortFormat = sfAlphabetic
              end
        ...
        object rgninformation: TIWRegion
          Left = 320
          Top = 380
          Width = 542
          Height = 113
          ...
          object txtnotedisc: TIWText
            ...
            Font.Size = 7
            Font.Style = []
            FriendlyName = 'txtnotedisc'
            Lines.Strings = (
              
                'Note: The variation in levels for constructed criteria may resul' +
                't in significant changes in the simulation results. ')
            RawText = False
            UseFrame = False
            WantReturns = True
          end
          object txtnatural: TIWText
            Left = 3
            Top = 14
            Width = 606
            Height = 31
            ...
            Lines.Strings = (
                ...
                'Natural Criteria: Criteria defined in a continuous natural scale' +
                '.')
            RawText = False
            UseFrame = False
            WantReturns = True
          end
          object txtconstructed: TIWText
            Left = 3
            Top = 32
            Width = 513
            Height = 21
            ...
            Lines.Strings = (
                ...
                'Constructed Criteria: Criteria defined in a constructed scale wi' +
                'th discrete values.')
            RawText = False
            UseFrame = False
            WantReturns = True
