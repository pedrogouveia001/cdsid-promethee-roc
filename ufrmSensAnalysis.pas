...
type
  TGrid = class(TIWGrid);
    ...
    IWLabel29: TIWLabel;
    btnbackweight: TIWButton;
    btnsaveWeight: TIWButton;
    btnstartWeight: TIWButton;
    rgnweight: TIWRegion;
    tbctrlVariationPage0: TIWTabPage;
    lblSOCSAV: TIWLabel;
    btnbackmconseq: TIWButton;
    btnsavemconseq: TIWButton;
    btnStartmconseq: TIWButton;
    LBLInformation: TIWLabel;
    rgnMConseq: TIWRegion;
...
btnsaveMConseq.enabled := True;
btnbackMConseq.enabled := False;
btnstartMConseq.Enabled := False;

btnsaveWeight.enabled := True;
btnbackWeight.enabled := False;
...
begin
  ...
  begin
   grdvariation.Cells[1,i] := CritName[i];
   if (Prefdir[i] = 1) then
  ...
  begin
    ...
    lblminMConseq[i].Parent := rgnMconseq;
    lblminMConseq[i].Left := 680 + 15;
    ...
    lblmaxMConseq[i].Parent := rgnMconseq;
    lblmaxMConseq[i].Left := 880 + 15;
    ...
    begin
      ...
      edtminMConseq[i].Parent := rgnMconseq;
      edtminMConseq[i].Left := 680 + 31;
      ...
      //edtminMConseq[i].Name := 'edtminMConseq' + inttostr(i);
      edtminMConseq[i].Visible := False;
      edtminMConseq[i].ZIndex := 10000;


      edtmaxMConseq[i] := TiwEdit.Create(Self);
      edtmaxMConseq[i].Parent := rgnMconseq;
      edtmaxMConseq[i].Left := 880+31;
      ...
      //edtmaxMConseq[i].Name := 'edtmaxMConseq' + inttostr(i);
      edtmaxMConseq[i].Visible := False;
      edtmaxMConseq[i].ZIndex := 10000;

      lblminvariationMConseq[i] := TiwLabel.Create(Self);
      lblminvariationMConseq[i].Parent := rgnMconseq;
      lblminvariationMConseq[i].Left := 680 + 92;
      lblminvariationMConseq[i].Top := 26 + i*23;
      lblminvariationMConseq[i].Font.FontName := 'verdana';
      lblminvariationMConseq[i].Caption := '%';
      lblminvariationMConseq[i].Name := 'lblminvariationMConseq' + inttostr(i);
      lblminvariationMConseq[i].Visible := False;
      lblminvariationMConseq[i].ZIndex := 10000;

      lblmaxvariationMConseq[i] := TiwLabel.Create(Self);
      lblmaxvariationMConseq[i].Parent := rgnMconseq;;
      lblmaxvariationMConseq[i].Left := 880+92;
      lblmaxvariationMConseq[i].Top := 26 + i*23;
      lblmaxvariationMConseq[i].Font.FontName := 'verdana';
      lblmaxvariationMConseq[i].Caption := '%';
      //lblmaxvariationMConseq[i].Name := 'lblmaxvariationMConseq' + inttostr(i);
      lblmaxvariationMConseq[i].Visible := False;
      lblmaxvariationMConseq[i].ZIndex := 10000;
    end;
    if grdvariation.Cells[2,i] = 'Constructed' then
    begin
      cmbbxminMConseq[i] := tiwComboBox.Create(Self);
      cmbbxminMConseq[i].Parent := rgnMconseq;
      cmbbxminMConseq[i].Left := 680 + 31;
      cmbbxminMConseq[i].Top := 26 + i*23;
      cmbbxminMConseq[i].Font.FontName := 'verdana';
      cmbbxminMConseq[i].Height := 21;
      cmbbxminMConseq[i].Width := 56;
      cmbbxminMConseq[i].Caption := '';
      //cmbbxminMConseq[i].Name := 'cmbbxminMConseq' + inttostr(i);
      cmbbxminMConseq[i].Visible := False;
      cmbbxminMConseq[i].ZIndex := 10000;

      cmbbxmaxMConseq[i] := tiwComboBox.Create(Self);
      cmbbxmaxMConseq[i].Parent := rgnMconseq;
      cmbbxmaxMConseq[i].Left := 880+31;
      cmbbxmaxMConseq[i].Top := 26 + i*23;
      cmbbxmaxMConseq[i].Font.FontName := 'verdana';
      cmbbxmaxMConseq[i].Height := 21;
      cmbbxmaxMConseq[i].Width := 56;
      cmbbxmaxMConseq[i].Caption := '';
      //cmbbxmaxMConseq[i].Name := 'cmbbxmaxMConseq' + inttostr(i);
      cmbbxmaxMConseq[i].visible := False;
      cmbbxmaxMConseq[i].ZIndex := 10000;

      j := 0;
      while j <= Niveis[i] do
      begin
        cmbbxmaxMConseq[i].Items.Add(floattostr(j));
        cmbbxminMConseq[i].Items.Add(floattostr(j));
        j := j + 1;
      end;
      ...
      lblminvariationMConseq[i].Top := 26 + i*23;
      lblminvariationMConseq[i].Font.FontName := 'verdana';
      lblminvariationMConseq[i].Caption := 'Levels';
      //lblminvariationMConseq[i].Name := 'lblminvariationMConseq' + inttostr(i);
      lblminvariationMConseq[i].Visible := False;
      lblminvariationMConseq[i].ZIndex := 10000;
      ...
      lblmaxvariationMConseq[i].Top := 26 + i*23;
      lblmaxvariationMConseq[i].Font.FontName := 'verdana';
      lblmaxvariationMConseq[i].Caption := 'Levels';
      //lblmaxvariationMConseq[i].Name := 'lblmaxvariationMConseq' + inttostr(i);
      lblmaxvariationMConseq[i].visible := False;
      lblmaxvariationMConseq[i].ZIndex := 10000;
    end;
  ...
  for i := 0 to Ncrit - 1 do
  begin
   grdweight.Cells[1,i] := CritName[i];
   if (Prefdir[i] = 1) then
    grdweight.Cells[2,i] := 'Minimization'
   else
    grdweight.Cells[2,i] := 'Maximization';

    grdweight.Cells[3,i] := FormatFloat( '0.00', simpeso[i]);
  end;
  ...
  begin
    ...
    lblminWeight[i].Parent := rgnweight;
    lblminWeight[i].Left := 680 + 15;
    ...
    lblmaxWeight[i].Parent := rgnweight;
    lblmaxWeight[i].Left := 880 + 15;
    ...
    edtminWeight[i].Parent := rgnweight;
    edtminWeight[i].Left := 680 + 31;
    ...
    edtmaxWeight[i].Parent := rgnweight;
    edtmaxWeight[i].Left := 880+31;
...
begin
  ...
  begin
   ...
   grdvariation.RowSelect[i] := False;
    ...
    if grdvariation.Cells[2,i] = 'Constructed' then
    begin
      cmbbxminMConseq[i].Destroy;
      cmbbxmaxMConseq[i].Destroy;
      lblminvariationMConseq[i].Destroy;
      lblmaxvariationMConseq[i].Destroy;
    end;
  end;
...
begin
  ...
  for i := 0 to TIWUserSession(WebApplication.Data).Nalt - 1 do
    for j := 0 to TIWUserSession(WebApplication.Data).Nalt - 1 do
      if TIWUserSession(WebApplication.Data).finalranking[i] = TIWUserSession(WebApplication.Data).finalrankingsim[j] then
...
begin
  ...
  begin
    ...
    begin
      ...
      edtmaxMConseq[i].font.Color := clBlack;
      edtminMConseq[i].font.Color := clBlack;
      end;
      if grdvariation.Cells[2,i] = 'Constructed' then
      begin
      cmbbxmaxMConseq[i].enabled := True;
      cmbbxminMConseq[i].enabled := True;
      cmbbxmaxMConseq[i].font.Color := clBlack;
      cmbbxminMConseq[i].font.Color := clBlack;
      end;
    end;
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      edtmaxWeight[i].font.Color := clBlack;
      edtminWeight[i].font.Color := clBlack;
    end;
  end;
end;
btnsaveWeight.Enabled := true;
...
btnsaveMConseq.Enabled := False;
btnbackMConseq.Enabled := true;
btnstartMConseq.enabled := True;
        ...
        for j := 1 to TIWUserSession(WebApplication.Data).Nalt do
          ...
          TIWUserSession(WebApplication.Data).MConseq[j - 1, i - 1] :=
            TriangularPDF(TIWUserSession(WebApplication.Data)
              .simMConseq[j - 1, i - 1] * (100 - TIWUserSession(WebApplication.Data)
                  .PminMConseq[i]) / 100, TIWUserSession(WebApplication.Data).simMConseq[j - 1, i - 1] *
              (100 + TIWUserSession(WebApplication.Data).PmaxMConseq[i]) / 100)
      end
      else
      for j := 1 to TIWUserSession(WebApplication.Data).Nalt do
      TIWUserSession(WebApplication.Data).MConseq[j - 1, i - 1] :=
